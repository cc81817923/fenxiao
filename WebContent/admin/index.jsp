...
<body>
    ...
    <header class="navbar navbar-default" id="bjui-header">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://www.newwing.com" target="_blank"><img src="../res/images/hansanlogo.png"></a>
        </div>
    ...
    <footer id="bjui-footer">Copyright &copy; 2014 - 2016 <a href="http://www.newwing.com" target="_blank">厦门市东南正新信息科技有限公司</a> 
    </footer>
</body>
</html>