...
<title>东南正新网络newwing后台管理系统</title>
...
<body>
    ...
    <header class="navbar navbar-default" id="bjui-header">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://www.newwing.com" target="_blank"><img src="../res/images/newwinglogo.png"></a>
        </div>
                ...
                <div class="page unitBox">
                    <div class="bjui-pageHeader" style="background:#FFF;">
                        <div style="padding: 0 5px;">
                            ...
                            <h4 style="margin-bottom:20px;">欢迎使用东南正新网络卡密微商城程序&nbsp;<small>最好用的卡密微商城程序</small></h4>
                            	<div class="col-md-6">
                            		<h5>东南正新网络卡密微商城程序</h5>
                                ...
                                <div class="col-md-6">
                                	...
                                	<h5>东南正新网络：<a href="http://www.newwing.com/" target="_blank">http://www.newwing.com/</a></h5>
                                    <h5>东南正新网络论坛：<a href="http://bbs.newwing.com/" target="_blank">http://bbs.newwing.com/</a></h5>        
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer id="bjui-footer">Copyright &copy; 2012 - 2015 <a href="http://www.newwing.com" target="_blank">东南正新网络</a> <a href="http://bbs.newwing.com" target="_blank">东南正新网络论坛</a> <a href="http://www.919dns.com" target="_blank">919数据中心</a>
    </footer>
</body>
</html>